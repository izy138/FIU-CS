...
echo "=========================================================================="
echo "                  HOMEWORK-5: Batch Autograder                            "
echo "=========================================================================="
echo "Date: $(date)"
echo

# Check if autograder script exists
if [ ! -f "autograder_HW5.sh" ]; then
    echo "ERROR: autograder_HW5.sh not found in current directory!"
...
REQUIRED_C_FILES=("submission_HW5.c")
...
for zip_file in "${zip_files[@]}"; do
    ...
    if [ ${#FOUND_FILES[@]} -eq 0 ]; then
        log_message "  ⚠️ ERROR: No submission of \"submission_HW5.c\" found"
    ...
    if [ "$SHOULD_GRADE" = true ]; then
        ...
        AUTOGRADER_OUTPUT=$(timeout 30 ./autograder_HW5.sh 2>&1)
