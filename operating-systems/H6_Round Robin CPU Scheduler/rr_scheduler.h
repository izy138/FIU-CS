...
void sjf_non_preemptive_scheduling(SchedulerContext *ctx);
void srt_preemptive_scheduling(SchedulerContext *ctx);
void round_robin_scheduling(SchedulerContext *ctx, int time_quantum);
void priority_non_preemptive_scheduling(SchedulerContext *ctx);
