...
# =============================================================================
ASSIGNMENT_NAME="HOMEWORK-6: RR Scheduler"
TOTAL_POINTS=100

# Test case weights (must sum to exactly 100)
declare -A TEST_WEIGHTS=(
    ["1"]=12.5    # Test 1 worth 12.5 points 
    ["2"]=12.5    # Test 2 worth 12.5 points 
    ["3"]=12.5    # Test 3 worth 12.5 points 
    ["4"]=12.5    # Test 4 worth 12.5 points     
	["5"]=12.5    # Test 5 worth 12.5 points 
    ["6"]=12.5    # Test 6 worth 12.5 points 
    ["7"]=12.5    # Test 7 worth 12.5 points 
    ["8"]=12.5    # Test 8 worth 12.5 points     
)
