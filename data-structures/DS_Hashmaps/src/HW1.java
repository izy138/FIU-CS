...
public class HW1 {
    ...
    public static char findDistinguishingChat(String str1, String str2) {
    ...
    public static int sumOfUniqueElements(int[] arr) {
        ...
        // checks if the value is 1 and adds it to sum
...
//        return treeRoot;
    ...
    public static void main(String[] args) {
        System.out.println("\nProblem 1:");
        System.out.println(findDistinguishingChat("abcde", "abbbbcccddee"));
